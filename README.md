...
The application was developed according to the J2EE architecture model and Tomcat as web server. Furthermore, I used a MySQL relational database for persistent data management and Hibernate for data mapping between Java and the database.
...
The configuration file "server.xml" used for Tomcat is the following:
```
